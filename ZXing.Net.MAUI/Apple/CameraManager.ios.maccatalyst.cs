...
namespace ZXing.Net.Maui
{
    internal partial class CameraManager
    {
        ...
        {
            if (captureDevice != null && zoomLevel <= captureDevice.MaxAvailableVideoZoomFactor)
            {
                //CaptureDevicePerformWithLockedConfiguration(() => captureDevice.VideoZoomFactor = new(zoomLevel));
                CaptureDevicePerformWithLockedConfiguration(() => captureDevice.RampToVideoZoom(new(zoomLevel), 2.0f));
            }
        }
